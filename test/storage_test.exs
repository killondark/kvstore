defmodule KVstore.StorageTest do
  ...
  setup do
    ...
    keys = List.flatten(:dets.match(:kvstore_test, {:"$1", :"_", :"_"}))
    Enum.each(keys, fn(key) -> :dets.delete(:kvstore_test, key) end)
  end
  ...
  test "update record in dets table" do
    ...
    assert :dets.match(:kvstore_test, {:"_", :"$1", :"_"}) == [["updated_test_value"]]
  end
end
